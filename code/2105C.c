...
#pragma config(Motor,  port6,           DriveFrontRight, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           DriveRearRight, tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
