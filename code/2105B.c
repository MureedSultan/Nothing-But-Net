...
#pragma config(Sensor, dgtl5,  pnu_bar1,       sensorDigitalOut)
...
#pragma config(Sensor, I2C_1,  DriveEncoderLeft, sensorNone)
#pragma config(Sensor, I2C_2,  DriveEncoder,   sensorNone)
...
#pragma config(Motor,  port7,           DriveRearRight, tmotorVex393_MC29, openLoop, reversed)
